...
<p align="center">
  <b>持续维护中</b>：由于现在架构，代码对于ai开发来说，演化进度难度很高，代码原生分布式能力弱，为了适应项目的长期发展，正在进行新一代架构重构，后端采用 Go 语言为核心，其强大的分布式能力是目前最优解，当前版本暂停维护，Issue、建议和 PR 都欢迎提交，旧项目的所有建议，都会逐步迁移到新版本。最早6月份上线新仓库，欢迎入群等待。
  抽空开了个ai模型中转站，支持gpt，cc顶级国外大模型，已过gpt cyber认证，国内直连，绝不掺水，按量付费，有需要的师傅可以看看：https://www.momoapi.shop/register?aff=XTCZ 走我邀请链接可以让我后台看到兄弟们
</p>
